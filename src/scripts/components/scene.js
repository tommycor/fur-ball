...
module.exports = {
	...
	render: function() {
		...
		this.spotLight.position.z = 8;

		for( var i = 0 ; i < this.geometry.vertices.length ; i++ ) {
			this.geometry.vertices[i].z = this.defaultZvalue[i]  + ( -.5 + this.pNoise.noise2D( this.defaultZvalue[i], time * .8) ) * 2.5;
		}
